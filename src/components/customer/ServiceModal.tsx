...
export function ServiceModal() {
  ...
  return createPortal(
    ...
    >
      <div className="pointer-events-auto relative w-full max-w-[760px] overflow-hidden rounded-[28px] border border-[#E8DCC8] bg-[#FAF6F0] shadow-[0_24px_80px_rgba(62,39,35,0.28)]">
        <div
